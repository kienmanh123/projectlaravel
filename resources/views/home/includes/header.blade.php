                    ...
                    <div class="search-bar-top">
                        <div class="search-bar">
                            ...
                            <select name ="id">
                                ...
                                <input name="search" placeholder="Nhập từ khóa..." type="search" value="{{Request::input('q')}}">
                                ...
                                <ul class="shopping-list">
                                    ...
                                    <li>
                                        ...
                                        <a class="cart-img" href="{{ route('home.product.detail',[$cart->options['slug']]) }}"><img src="{{ asset('uploads/products/' . $cart->options['image']) }}" alt="#"></a>
                                            ...
                                            <p class="quantity">{{ $cart->qty }}<span class="amount">{{number_format($cart->price,0,",",".")}}VND</span></p>
                                    </li>
                                   @endforeach
                                </ul>
                                <div class="bottom">
